...
With a Gemini API key the exercises are generated by the model. Without one, the app falls back to a built-in generator that runs entirely in the browser. The offline generator honours:
...
*   Node.js 18+
*   A [Google Gemini API Key](https://aistudio.google.com/) (optional — without it the app runs in [offline mode](#offline-mode)).
